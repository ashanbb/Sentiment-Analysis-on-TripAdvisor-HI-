...
this_file_name = 'C:/Users/abogollagama/Documents/SPS NU/PREDICT 452 - Web and Network Data Science/Team Project/Reviews/cleaned_reviews.csv' 
...
text.concordance("beach") # sentences using the word beach

text.dispersion_plot(["clean", "ocean", "view", "relaxing", "beach", "fun"]) # trending of keywords used
